...
drop database if exists db1551445;
...
insert into user (username,keyword,firstlog) values
('MiaoMiaoYang','214365',true),
('zhengxuanci' ,'214365',true),
('tongjiayan' ,'214365',true),
('test1'  ,'214365',false),
('test2'  ,'214365',false)
;
